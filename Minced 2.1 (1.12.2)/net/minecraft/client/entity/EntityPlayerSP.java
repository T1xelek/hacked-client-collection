...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public void onUpdate() {
        EventManager.call((Event) new EventPreUpdate());
        ...
        EventManager.call((Event) new baritone.events.events.player.EventUpdate());
    }
    ...
    public void onLivingUpdate() {
        ...
        EventManager.call((Event) myEvent);
                    ...
                    if (f13 >= -0.15F) {
                        ...
                        if (iblockstate.getCollisionBoundingBox(this.world, blockpos) == null) {
                            ...
                            if (iblockstate1.getCollisionBoundingBox(this.world, blockpos) == null) {
                                ...
                                AxisAlignedBB axisalignedbb = (new AxisAlignedBB(vec3d, vec3d4.add(0.0D, (double) f10, 0.0D))).expand((double) f9, 0.0D, (double) f9);
