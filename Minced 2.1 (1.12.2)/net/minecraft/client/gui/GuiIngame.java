...
public class GuiIngame extends Gui {
    ...
    public void renderGameOverlay(float partialTicks) {
        ...
        if (Timer.smart.getCurrentValue()) {
            Timer.animWidth = (float) RenderUtils.interpolate((100 - (Timer.ticks * 4)), Timer.animWidth, 0.05f);
            ...
            RoundedUtil.drawRound(rs.getScaledWidth() / 2 - 36/2 - 1, rs.getScaledHeight() - 65 - 2, 35 + 2, 10, 2, new Color(25,25,25));
            mc.Nunito14.drawCenteredString("Timer", (float) (rs.getScaledWidth() / 2), (float) (rs.getScaledHeight() - 64f), -1);
            RoundedUtil.drawRound(rs.getScaledWidth() / 2 - 76/2 - 1, rs.getScaledHeight() - 80 - 1, 75 + 2, 10 + 2, 2, new Color(25,25,25));
            RoundedUtil.drawGradientRound(rs.getScaledWidth() / 2 - 76/2, rs.getScaledHeight() - 80, Timer.animWidth * 3/4, 10, 1,oneColor.getColorValueColor().darker(), oneColor.getColorValueColor().darker(), new Color(255,255,255),  new Color(255,255,255));
            mc.Nunito15.drawCenteredStringWithShadow((int) Math.round(Timer.animWidth) + "%", (float) (rs.getScaledWidth() / 2), (float) (rs.getScaledHeight() - 78f), -1);
            RenderUtils.drawRect2(rs.getScaledWidth() + 200, rs.getScaledHeight() - 80 , 102, 7, new Color(1, 1, 1, 50).getRGB());
            RenderUtils.drawRect2(rs.getScaledWidth() + 200, rs.getScaledHeight() - 80, Timer.animWidth, 5, new Color(155, 62, 224).getRGB());
        ...
        for (Score score1 : collection) {
            ...
            if (server.contains("reallyworld")) {
                if (s1.contains("GRIEF")) {
                    grief = (int) Double.parseDouble(s1.replace("\u00a77\u2551 \u00a7f\u0421\u0435\u0440\u0432\u0435\u0440\u00a7l: \u00a71\u00a76GRIEF-", ""));
                }
            }
            if (tuskevich.instance.featureManager.getFeature(NameProtect.class).isEnabled() && NameProtect.scoreboardSpoof.getCurrentValue()) {
                s1 = s1.contains("\u041d\u0438\u043a") ? "\u00a77\u2551 \u00a7f\u041d\u0438\u043a\u00a7l: \u00a76\u00a77\u00a76" + "tuskevich" : s1.contains("GRIEF") ? "\u00a77\u2551 \u00a7f\u0421\u0435\u0440\u0432\u0435\u0440\u00a7l: \u00a71\u00a76GRIEF-1337" : s1.contains("\u0420\u0430\u043d\u0433") ? "\u00a77\u2551 \u00a7f\u0420\u0430\u043d\u0433\u00a7l: \u00a73\u00a7c\u00a7lADMIN" : s1.contains("\u041a\u043b\u0430\u043d") ? "\u00a77\u2551 \u00a7f\u041a\u043b\u0430\u043d\u00a7l: \u00a7e\u00a75\u00a7fMINCED" : s1;
            }
