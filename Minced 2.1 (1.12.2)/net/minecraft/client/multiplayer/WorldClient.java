...
public class WorldClient extends World
{
    ...
    public void sendFullInventoryLeavePacket() {
        this.connection.getNetworkManager().closeChannel((ITextComponent)new TextComponentString(ChatFormatting.GREEN + "Baritone " + ChatFormatting.WHITE + "disconnected you from server, because of your inventory is full!"));
    }
