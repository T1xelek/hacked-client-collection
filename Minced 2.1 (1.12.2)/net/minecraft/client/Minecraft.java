...
public class Minecraft implements IThreadListener, ISnooperInfo {
    ...
    public MCFontRenderer Nunito14;
    public MCFontRenderer Nunito15;
    public MCFontRenderer Nunito16;
    public MCFontRenderer Nunito17;
    ...
    public MCFontRenderer styleicons_25;
    public MCFontRenderer tenacity;
    ...
    public MCFontRenderer tenacity20;
    ...
    private void startGame() throws LWJGLException, IOException {
        ...
        this.mntsb_30 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("font/mntsb.ttf"), 30.0f, 0), true, true);
        this.mntsb_18 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("font/mntsb.ttf"), 18.0f, 0), true, true);
        this.mntsb_17 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("font/mntsb.ttf"), 17.0f, 0), true, true);
        this.mntsb_16 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("font/mntsb.ttf"), 16.0f, 0), true, true);
        this.mntsb_15 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("font/mntsb.ttf"), 15.0f, 0), true, true);
        this.mntsb_14 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("font/mntsb.ttf"), 14.0f, 0), true, true);
        this.mntsb_13 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("font/mntsb.ttf"), 13.0f, 0), true, true);
        this.tenacity = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("font/tenacity.ttf"), 16.0f, 0), true, true);
        this.tenacity20 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("font/tenacity.ttf"), 40.0f, 0), true, true);
        this.Nunito14 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("font/nunitobl.ttf"), 14.0f, 0), true, true);
        this.Nunito15 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("font/nunitobl.ttf"), 15.0f, 0), true, true);
        this.Nunito16 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("font/nunitobl.ttf"), 16.0f, 0), true, true);
        this.Nunito17 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("font/nunitobl.ttf"), 17.0f, 0), true, true);

        this.stylesicons_14 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("font/stylesicons.ttf"), 14.0f, 0), true, true);
        this.styleicons_25 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("font/stylesicons.ttf"), 32.0f, 0), true, true);

        this.notification = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("font/stylesicons.ttf"), 40.0f, 0), true, true);
    ...
    private void setWindowIcon() {
        ...
        if (util$enumos != Util.EnumOS.OSX) {
            ...
            try {
                inputstream = this.mcDefaultResourcePack.getInputStream(new ResourceLocation("minced/avatar64.jpg"));
                inputstream1 = this.mcDefaultResourcePack.getInputStream(new ResourceLocation("minced/avatar32.jpg"));
