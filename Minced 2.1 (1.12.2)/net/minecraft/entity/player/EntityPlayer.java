    ...
    public float getEyeHeight() {
        ...
        if (this.isPlayerSleeping()) {
            ...
            if (this.isElytraFlying() || this.height == 0.6F) {
                if (tuskevich.instance.featureManager.getFeature(SunriseElytra.class).isEnabled() || tuskevich.instance.featureManager.getFeature(Speed.class).isEnabled() && Speed.speedMode.currentMode.equals("Matrix Elytra")) {
                    f = 1.62F;
                } else {
                    f = 0.4F;
                }
