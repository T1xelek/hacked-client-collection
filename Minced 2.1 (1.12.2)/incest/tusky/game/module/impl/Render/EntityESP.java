...
public class EntityESP
    ...
    public static ListSetting healcolorMode = new ListSetting("Color Health Mode", "Astolfo", () -> healRect.getCurrentValue() && espMode.currentMode.equals("2D"), "Astolfo", "Rainbow", "Custom");
    ...
    public static ListSetting colorMode = new ListSetting("Color Box Mode", "Rainbow", () -> espMode.currentMode.equals("Box") || espMode.currentMode.equals("2D"), "Astolfo", "Rainbow", "Custom");
    public BooleanSetting mobESP;
    public static Entity clipEntity;

    public EntityESP() {
        super("EntityESP", "Рисует бокс на энтити", ModuleCategory.Visual);
        ...
        colorEsp = new ColorSetting("ESP Color", new Color(0xFFFFFF).getRGB(), () -> (espMode.currentMode.equals("2D") || espMode.currentMode.equals("Box")));
    ...
    public void onRender2D(EventRender2D event) {
        ...
        for (Entity entity : Helper.mc.world.loadedEntityList) {
            ...
            if (tuskevich.instance.friendManager.isFriend(entity.getName()) && friendHighlight.getCurrentValue()) {
            ...
            double height = (double) entity.height + (entity.isSneaking() || entity == EntityESP.mc.player && EntityESP.mc.player.isSneaking() ? -0.3 : !(!tuskevich.instance.featureManager.getFeature(CustomModel.class).isEnabled() || CustomModel.onlyMe.getCurrentValue() && entity != EntityESP.mc.player || !CustomModel.modelMode.currentMode.equals("Crab") && !CustomModel.modelMode.currentMode.equals("Amogus") && !CustomModel.modelMode.currentMode.equals("Chinchilla") && !CustomModel.modelMode.currentMode.equals("Red Panda")) ? -0.5 : 0.2);
