...
public class PearlESP extends Module {
    ...
    private final ListSetting triangleMode = new ListSetting("Triangle Mode", "Custom", () -> triangleESP.getCurrentValue(), "Rainbow", "Custom");
    private final ColorSetting triangleColor;


    public PearlESP() {
        super("PearlESP", "Показывает куда полетит эндер-жемчуг", ModuleCategory.Player);
