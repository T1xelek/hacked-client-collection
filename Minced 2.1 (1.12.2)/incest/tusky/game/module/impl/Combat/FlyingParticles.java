...
import incest.tusky.game.utils.otherutils.gayutil.NewPalleteHelper;
...
public class FlyingParticles extends Module {
    ArrayList<partical> particals = new ArrayList();
    public ListSetting fparticlesMode = new ListSetting("Particles Mode", "Astolfo", new String[]{"Astolfo", "Rainbow", "Pulsive",  "Static"});
    ...
    public FlyingParticles() {
        super("FlyingParticles", "Красивые летающие партиклы после удара", ModuleCategory.Combat);
