...
public class GifEngine {
    ...
    public void bind(int x, int y) {
        this.x = x;
        this.y = y;
        UIRender.bind((float)this.x + 5.0F, (float)this.y, (float)(this.width / tuskevich.scale.getScale()), (float)(this.height / tuskevich.scale.getScale()), 1.0F, this.getTexture().getGlTextureId());
    }
