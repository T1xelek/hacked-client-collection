...
import static incest.tusky.game.utils.otherutils.tenacity.TenacityMathUtil.interpolate;
import static org.lwjgl.opengl.GL11.*;

public class TenacityRenderUtil implements Helper {
    ...
    public static void renderRoundedRect(float x, float y, float width, float height, float radius, int color) {
        TenacityRenderUtil.drawGoodCircle(x + radius, y + radius, radius, color);
        TenacityRenderUtil.drawGoodCircle(x + width - radius, y + radius, radius, color);
        TenacityRenderUtil.drawGoodCircle(x + radius, y + height - radius, radius, color);
        TenacityRenderUtil.drawGoodCircle(x + width - radius, y + height - radius, radius, color);
