package incest.tusky.game.utils.otherutils.tenacity;

import java.awt.*;
import java.awt.image.BufferedImage;

import static incest.tusky.game.utils.otherutils.tenacity.TenacityMathUtil.interpolateFloat;
import static incest.tusky.game.utils.otherutils.tenacity.TenacityMathUtil.interpolateInt;

public class TenacityColorUtil {
    ...
    public static Color imitateTransparency(Color backgroundColor, Color accentColor, float percentage) {
        return new Color(TenacityColorUtil.interpolateColor(backgroundColor, accentColor, (255 * percentage) / 255));
    }
    ...
    public static Color interpolateColorsBackAndForth(int speed, int index, Color start, Color end, boolean trueColor) {
        ...
        return trueColor ? TenacityColorUtil.interpolateColorHue(start, end, angle / 360f) : TenacityColorUtil.interpolateColorC(start, end, angle / 360f);
    }
