...
public class ColorUtils implements Helper {
    ...
    public static int getHealthColor(float health, float maxHealth) {
        return Color.HSBtoRGB(Math.max(0.0F, Math.min(health, maxHealth) / maxHealth) / 3, 10, 0.8f) | 0xFF000000;
    }
    ...
    public static Color interpolateColorsBackAndForth(int i, int yTotal, Color onecolor, Color twoColor, boolean b) {
        return null;
    }

    public static Color applyOpacity(Color gradientColor4, float v) {
        return null;
    }
}
