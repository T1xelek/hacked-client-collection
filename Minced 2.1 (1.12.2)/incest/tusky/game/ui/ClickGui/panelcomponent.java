...
import incest.tusky.game.ui.ClickGui.component.AnimationState;
import incest.tusky.game.ui.ClickGui.component.Component;
import incest.tusky.game.ui.ClickGui.component.DraggablePanel;
...
public final class panelcomponent extends DraggablePanel {
    ...
    public incest.tusky.game.ui.ClickGui.component.AnimationState state;
    private int prevX;
    private int prevY;
    ...
    public void drawComponent(ScaledResolution scaledResolution, int mouseX, int mouseY) {
        ...
        if (isExpanded()) {
            for (incest.tusky.game.ui.ClickGui.component.Component component : components) {
                component.setY(height);
                component.drawComponent(scaledResolution, mouseX, mouseY);
                int cHeight = component.getHeight();
                if (component instanceof incest.tusky.game.ui.ClickGui.component.ExpandableComponent) {
                    incest.tusky.game.ui.ClickGui.component.ExpandableComponent expandableComponent = (incest.tusky.game.ui.ClickGui.component.ExpandableComponent) component;
    ...
    public int getHeightWithExpand() {
        ...
        if (isExpanded()) {
            for (Component component : components) {
                int cHeight = component.getHeight();
                if (component instanceof incest.tusky.game.ui.ClickGui.component.ExpandableComponent) {
                    incest.tusky.game.ui.ClickGui.component.ExpandableComponent expandableComponent = (ExpandableComponent) component;
                    if (expandableComponent.isExpanded())
                        cHeight = expandableComponent.getHeightWithExpand() + 5;
                }
                height += cHeight;
