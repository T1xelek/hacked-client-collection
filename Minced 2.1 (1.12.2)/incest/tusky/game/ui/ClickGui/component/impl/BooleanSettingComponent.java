...
public class BooleanSettingComponent extends Component implements PropertyComponent {
    ...
    public void drawComponent(ScaledResolution scaledResolution, int mouseX, int mouseY) {
        if (booleanSetting.isVisible()) {
            ...
            mc.mntsb_14.drawString(getName(), x - 2, y + middleHeight, tuskevich.instance.featureManager.getFeature(parent.getName()).isEnabled() ? Color.WHITE.getRGB() : Color.BLACK.getRGB());
