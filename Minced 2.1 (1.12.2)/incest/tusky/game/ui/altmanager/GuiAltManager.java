package incest.tusky.game.ui.altmanager;

import incest.tusky.game.tuskevich;
import incest.tusky.game.module.impl.Util.NameProtect;
import incest.tusky.game.ui.altmanager.alt.Alt;
import incest.tusky.game.ui.altmanager.alt.AltLoginThread;
import incest.tusky.game.ui.altmanager.alt.AltManager;
import incest.tusky.game.ui.altmanager.api.AltService;
...
public class GuiAltManager extends GuiScreen {
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        String altName = "Name: " + (tuskevich.instance.featureManager.getFeature(NameProtect.class).isEnabled() && NameProtect.myName.getCurrentValue() ? "Protected" : mc.session.getUsername());
        ...
        while (true) {
            ...
            GlStateManager.popMatrix();
            mc.rubik_16.drawString((tuskevich.instance.featureManager.getFeature(NameProtect.class).isEnabled() && NameProtect.myName.getCurrentValue() ? "Protected" : name), (float) width / 2.0f - 80, (float) ((double) y - offset + 5.0), -1);
