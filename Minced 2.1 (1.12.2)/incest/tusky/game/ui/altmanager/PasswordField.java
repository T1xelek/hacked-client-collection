    ...
    public void drawTextBox() {
        if (this.func_73778_q()) {
            if (this.getEnableBackgroundDrawing()) {
                RenderUtils.drawRect(this.xPos, this.yPos, this.xPos + this.width, this.yPos + this.height, new Color(30, 30, 30, 185).getRGB());
                RenderUtils.drawGradientRect(this.xPos, this.yPos, this.xPos + this.width, this.yPos + this.height, new Color(1, 1, 1, 255).getRGB(), new Color(5, 5, 5, 255).getRGB());
            }
